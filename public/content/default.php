...
$title = 'Волгоградский Колледж Управления и Новых Технологий';
$style = '<link href="css/style/default.css" rel="stylesheet" />';
$carousel = '<script src="js/js/slide.js"></script>';

echo '<title>'.$title.'</title>';
echo '<head>'.$style.$carousel.'</head>';
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
						    ...
						    <?php
			                    include $_SERVER['DOCUMENT_ROOT'].'/content/news/main/1.php';   
		                    ?>							
				...
				<div>
					<p class="text-center"><a href="index.php?id=news/main/news-all">Все новости</a></p>
				</div>
			</div>
		</div>
	</div>
...
<article>
	<div class="container">
		...
		<div>
			<p class="text-center"><a href="index.php?id=commission/commission">Подробнее</a></p>
		</div>
